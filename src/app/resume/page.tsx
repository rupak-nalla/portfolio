...
//         <main>
//             <NavBar />
//             <div className="bg-[url(/images/bg.png)] min-h-screen bg-cover bg-no-repeat">
//                 <div className="bg-gradient-to-b from-black via-transparent to-black min-h-screen flex flex-col justify-start items-center pt-24 space-y-6">
//                     <a 
...
//                         DOWNLOAD
//                     </a>
//                     <div className="w-full max-w-3xl bg-white shadow-lg rounded-lg overflow-hidden p-4">
